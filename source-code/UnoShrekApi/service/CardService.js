...
export default class CardService {
  ...
  async getAll() {
    // Convert database documents into response DTOs before returning them.
  ...
  async create(data) {
    // Validate and normalize the incoming payload before persisting it.
  ...
  async update(id, data) {
    // Reuse the request DTO so updates follow the same validation rules.
