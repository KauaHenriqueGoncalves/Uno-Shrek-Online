...
import shrekBg from "../../../assets/register-image-left.png";
...
export default function RegisterPage() {
  ...
  function validate() {
    ...
    if (form.password.length < 8)  errs.password = "Use 8 or more characters";
    return errs;
  }
        ...
        <div className="auth-form-wrapper">
          ...
          <form onSubmit={onSubmit} noValidate className="auth-form">
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <span className="spinner" /> : "Create an account"}
            </button>
          </form>
